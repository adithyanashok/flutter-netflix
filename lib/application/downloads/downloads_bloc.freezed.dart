...
class __$$_GetDownloadsImagesCopyWithImpl<$Res>
    extends _$DownloadEventCopyWithImpl<$Res, _$_GetDownloadsImages>
...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailure, List<Downloads>>> get downloadsOptions =>
      throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailure, List<Downloads>>> downloadsOptions});
}
...
class _$_DownloadsState implements _DownloadsState {
  ...
  @override
  final Option<Either<MainFailure, List<Downloads>>> downloadsOptions;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadsOptions: $downloadsOptions)';
  }
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<Downloads>>>
          downloadsOptions}) = _$_DownloadsState;
